...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-SUNQHTF7.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-YDO65WKW.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-Q3ZQBDAQ.js";
import {
  require_react_dom
...
function useSize(element) {
  const [size3, setSize] = React4.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var Slot = React7.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime5.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React7.isValidElement(newElement) ? React7.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var TooltipProvider = (props) => {
  ...
  const [isOpenDelayed, setIsOpenDelayed] = React9.useState(true);
  const isPointerInTransitRef = React9.useRef(false);
  const skipDelayTimerRef = React9.useRef(0);
  React9.useEffect(() => {
  ...
  return (0, import_jsx_runtime7.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayed,
      delayDuration,
      onOpen: React9.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        setIsOpenDelayed(false);
      }, []),
      onClose: React9.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React9.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React9.useRef(false);
  ...
  const stateAttribute = React9.useMemo(() => {
  ...
  const handleDelayedOpen = React9.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return (0, import_jsx_runtime7.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime7.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React9.useCallback(() => {
...
var TooltipTrigger = React9.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React9.useRef(false);
    const handlePointerUp = React9.useCallback(() => isPointerDownRef.current = false, []);
    React9.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime7.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime7.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime7.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React9.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime7.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime7.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React9.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React9.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React9.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React9.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React9.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime7.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var TooltipContentImpl = React9.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
        ...
        children: (0, import_jsx_runtime7.jsxs)(
          Content,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime7.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime7.jsx)(Root3, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React9.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime7.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
