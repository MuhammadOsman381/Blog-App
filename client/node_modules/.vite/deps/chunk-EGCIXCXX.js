...
var FocusScope = React4.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Primitive2.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React16.Children.map(children, (child) => (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
//# sourceMappingURL=chunk-EGCIXCXX.js.map
